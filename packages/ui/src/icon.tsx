...
const paths = {
  ...
  /* La caja del calendario usa el mismo radio de 2.5 que `image` y `folder`: en
     la grilla de 24 es el radio que se lee como esquina redondeada a 20px sin
     volverse una pastilla. La línea de la cabecera va en 10 y no en 9 — con la
     caja arrancando en 5, deja la cabecera de 5 y el cuerpo de 10, que es la
     proporción de un calendario de verdad. */
  calendar: 'M4 7.5A2.5 2.5 0 016.5 5h11A2.5 2.5 0 0120 7.5v10a2.5 2.5 0 01-2.5 2.5h-11A2.5 2.5 0 014 17.5v-10zM4 10h16M8.5 3.5v3M15.5 3.5v3',
  /* La lámpara: un arco mayor de radio 5.5 entre (9,14.5) y (15,14.5), que es
     el bulbo, cerrado abajo con un cuello de 6×2.5, y la rosca como una línea
     suelta. El arco va con `1 1` —mayor y en sentido horario— porque con el
     menor la cúpula sale para abajo y queda un cuenco. Verificado por la
     parametrización: centro en (12, 9.89), barrido de 294°, y el punto más
     alto en y=4.39, así que el icono entero va de 4.39 a 19.5 dentro de la
     grilla de 24. */
  bulb: 'M9 14.5a5.5 5.5 0 116 0V17H9z M10 19.5h4',
} as const
