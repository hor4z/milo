...
export function BookStory() {
  return (
    <Section
      title="Book"
      note="Una tapa en tres dimensiones, con su lomo y su canto de hojas. Es una portada —un tema, una guía, una colección— y no una tarjeta: en una grilla de doce filas iguales, doce libros son doce objetos pidiendo atención y ninguno la consigue. Para eso está Card."
    >
      <Block
        label="Las dos variantes"
      ...
      <Block
        label="El color sale de un token"
