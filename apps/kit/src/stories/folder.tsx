...
export function FolderStory() {
  return (
    ...
    >
      ...
      >
        <Card surface="muted" className={cls.card}>
      ...
      >
        <Card surface="muted" className={cls.card3}>
        ...
        <p className={cls.p2}>
          Se elige <strong className={cls.strong}>un solo color</strong>, el del cuerpo:
      ...
      >
        <Card surface="muted" className={cls.card4}>
          ...
          <Folder label="Con un icono" meta="4 archivos" badges={<Icon name="attach_file" size={16} className={cls.icon} />} />
        </Card>
        <p className={cls.p3}>
      ...
      >
        <Card surface="muted" className={cls.card5}>
          <Folder size={88} />
          <span className={cls.span}>la pieza · el glifo</span>
        </Card>
      </Section>
