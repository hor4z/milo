...
const picos = [0.2, 0.5, 0.8, 0.6, 0.9, 0.4, 0.7, 0.3, 0.85, 0.55, 0.25, 0.65, 0.45, 0.75, 0.35, 0.6]
    ...
    >
      ...
      >
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <Punto titulo="Con las pausas puestas">{`Una voz que no respeta el punto y la coma es intransitable. Si la sintética las come, se corrigen en el texto antes de leerlo, no después.`}</Punto>
          <Punto titulo="Los números se dicen, no se deletrean">{'`9,8` es "nueve coma ocho" y `3/4` es "tres cuartos", no "tres barra cuatro". En un producto donde se enseña matemática, esto es contenido y no formato.'}</Punto>
          <Punto titulo="Sin música atrás">{`Una base musical debajo de una explicación sube el esfuerzo de escucha para todo el mundo y la vuelve imposible para quien usa audífonos.`}</Punto>
        </div>
      </Section>
