...
**El repo es del design system y de nada más.** El UI kit —las 61 piezas— es una parte; las
...
npm test           # 374 tests con vitest y testing-library
...
`npm test` corre vitest con jsdom y testing-library. 374 tests, y lo que prueban es el
