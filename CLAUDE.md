...
npm test           # 382 tests con vitest y testing-library
...
de comandos que abre la barra, el bloque destacado, la imagen con pie y la fórmula. Se documentan
...
`npm test` corre vitest con jsdom y testing-library. 382 tests, y lo que prueban es el
