...
describe('TaskList', () => {
  it('es una lista con nombre: "lista, tres elementos" no dice de qué', () => {
    render(<TaskList items={steps} onToggle={() => {}} label="Pasos de la entrega" />)
  ...
  it('cada casilla se nombra con su propio texto', () => {
    render(<TaskList items={steps} onToggle={() => {}} label="Pasos" />)
  ...
  it('marcar devuelve el id y si quedó hecha', async () => {
    ...
    render(<TaskList items={steps} onToggle={onToggle} label="Pasos" />)
  ...
  it('apagada se lee y no se toca', async () => {
    const onToggle = vi.fn()
    render(<TaskList items={steps} onToggle={onToggle} label="Pasos" readOnly />)
