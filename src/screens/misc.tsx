...
import { Page, PageHeader, EmptyState, SectionLabel } from '../ui/page'
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        {kinds.map(k => (
          <Card key={k.label} interactive className="p-4">
            <span className={cx('mb-3 flex size-10 items-center justify-center rounded-xl', `bg-tint-${k.tint}`)}>
              <Icon name={k.icon} size={18} className="text-ink-muted" />
            </span>
